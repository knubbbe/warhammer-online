...
function InitializeWindow()
    ...
    e:SetText( T["Enable Hostile Target HUD"] )
    ...
    e:Resize( 450 )
    e:Align( "center" )
    e:AnchorTo( window.W.General, "top", "top", 0, 240 )
    e:Font( "font_chat_text" )
...
function ApplyConfigSettings()
	...
	-- General Settings
	--
	Pure.Set( "hostilehud-frame-show", window.W.General.EnableUnitFrame_Checkbox:GetValue() )
	Pure.Set( "hostilehud-sigil-show", window.W.General.ShowSigilRequirement_Checkbox:GetValue() )
	Pure.Set( "hostilehud-arch-color", window.W.General.EnableClassArchtypeColoringName_Checkbox:GetValue() )
	Pure.Set( "hostilehud-arch-color-hitpoints", window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:GetValue() )
	Pure.Set( "hostilehud-classname-show", window.W.General.ShowClassName_Checkbox:GetValue() )
	Pure.Set( "hostilehud-window-anchor", anchors[window.W.General.DirectionFromTarget_Combo:SelectedIndex()].config )
	Pure.Set( "hostilehud-window-dy", distanceFromTarget )
	Pure.Set( "hostilehud-frame-alpha", frameAlpha )
	Pure.Set( "hostilehud-frame-font-alpha", fontAlpha )
	
	--
	-- Dispel Settings
	--
	Pure.Set( "hostilehud-dispel-show", window.W.Dispel.EnableDispelHighlighting_Checkbox:GetValue() )
	Pure.Set( "hostilehud-dispel-color", { dispelRed, dispelGreen, dispelBlue } )
	Pure.Set( "hostilehud-dispel-alpha", dispelAlpha )
	
	--
	-- Color Settings
	--
	Pure.Set( "hostilehud-hitpoints-status-color", { hitRed, hitGreen, hitBlue } )
	Pure.Set( "hostilehud-rvr-flag-color", { rvrRed, rvrGreen, rvrBlue } )
end
...
function RevertConfigSettings()
	...
	-- General Settings
	--
	window.W.General.EnableUnitFrame_Checkbox:SetValue( Pure.Get( "hostilehud-frame-show" ) )
	window.W.General.ShowSigilRequirement_Checkbox:SetValue( Pure.Get( "hostilehud-sigil-show" ) )
	window.W.General.EnableClassArchtypeColoringName_Checkbox:SetValue( Pure.Get( "hostilehud-arch-color" ) )
	window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:SetValue( Pure.Get( "hostilehud-arch-color-hitpoints" ) )
	window.W.General.ShowClassName_Checkbox:SetValue( Pure.Get( "hostilehud-classname-show" ) )
	distanceFromTarget					= Pure.Get( "hostilehud-window-dy" )
	...
	frameAlpha							= Pure.Get( "hostilehud-frame-alpha" )
	...
	window.W.General.DirectionFromTarget_Combo:SelectIndex( anchorsLookup[Pure.Get( "hostilehud-window-anchor" )] )
	...
	-- Dispel Settings
	--
	dispelRed, dispelGreen, dispelBlue 	= unpack( Pure.Get( "hostilehud-dispel-color" ) )
	dispelAlpha							= Pure.Get( "hostilehud-dispel-alpha" )
	window.W.Dispel.EnableDispelHighlighting_Checkbox:SetValue( Pure.Get( "hostilehud-dispel-show" ) )
	...
	-- Color Settings
	--
	hitRed, hitGreen, hitBlue = unpack( Pure.Get( "hostilehud-hitpoints-status-color" ) )
    ...
    rvrRed, rvrGreen, rvrBlue = unpack( Pure.Get( "hostilehud-rvr-flag-color" ) )
...
function PureConfig_TargetHostileHUD_OnUpdate()
