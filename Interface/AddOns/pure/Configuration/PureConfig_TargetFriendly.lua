...
function InitializeWindow()
    ...
    e:SetText( T["Enable Friendly Target Unit Frame"] )
    ...
    e:Resize( 450 )
    e:Align( "center" )
    e:AnchorTo( window.W.General, "top", "top", 0, 190 )
    e:Font( "font_chat_text" )
...
function ApplyConfigSettings()
	...
	-- General Settings
	--
	Pure.Set( "friendly-frame-show", window.W.General.EnableUnitFrame_Checkbox:GetValue() )
	Pure.Set( "friendly-frame-handleinput", not window.W.General.ClickThroughUnitFrame_Checkbox:GetValue() )
	Pure.Set( "friendly-arch-color", window.W.General.EnableClassArchtypeColoringName_Checkbox:GetValue() )
	Pure.Set( "friendly-arch-color-hitpoints", window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:GetValue() )
	Pure.Set( "friendly-frame-showinsiege", window.W.General.ShowInSiegeWeapon_Checkbox:GetValue() )
	Pure.Set( "friendly-frame-alpha", frameAlpha )
	Pure.Set( "friendly-frame-font-alpha", fontAlpha )
	
	--
	-- Effect Settings
	--
	Pure.Set( "friendly-effects-show", window.W.Effects.EnableEffectTracker_Checkbox:GetValue() )
	Pure.Set( "friendly-effects-showlabels", window.W.Effects.ShowEffectLabels_Checkbox:GetValue() )
	Pure.Set( "friendly-effects-selfcastonly", window.W.Effects.ShowSelfCastEffectsOnly_Checkbox:GetValue() )
	Pure.Set( "friendly-effects-mythicborder", window.W.Effects.ShowMythicStyleBorder_Checkbox:GetValue() )
	Pure.Set( "friendly-effects-rows", tonumber( window.W.Effects.EffectRows_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-rows" ) )
	Pure.Set( "friendly-effects-cols", tonumber( window.W.Effects.EffectColumns_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-cols" ) )
	Pure.Set( "friendly-effects-dx", tonumber( window.W.Effects.EffectWidth_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-dx" ) )
	Pure.Set( "friendly-effects-dy", tonumber( window.W.Effects.EffectHeight_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-dy" ) )
	Pure.Set( "friendly-effects-anchor", anchors[window.W.Effects.Anchor_Combo:SelectedIndex()].config )
	Pure.Set( "friendly-effects-row-offset", tonumber( window.W.Effects.AnchorRowOffset_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-row-offset" ) )
	Pure.Set( "friendly-effects-col-offset", tonumber( window.W.Effects.AnchorColumnOffset_Textbox:GetText() ) or Pure.GetDefault( "friendly-effects-col-offset" ) )
	Pure.Set( "friendly-effects-alpha", effectAlpha )
	Pure.Set( "friendly-effects-font-alpha", effectFontAlpha )
	
	--
	-- Dispel Settings
	--
	Pure.Set( "friendly-dispel-show", window.W.Dispel.EnableDispelHighlighting_Checkbox:GetValue() )
	Pure.Set( "friendly-dispel-color", { dispelRed, dispelGreen, dispelBlue } )
	Pure.Set( "friendly-dispel-alpha", dispelAlpha )
	
	--
	-- Color Settings
	--
	Pure.Set( "friendly-hitpoints-status-color", { hitRed, hitGreen, hitBlue } )
	Pure.Set( "friendly-actionpoints-status-color", { actionRed, actionGreen, actionBlue } )
	Pure.Set( "friendly-rvr-flag-color", { rvrRed, rvrGreen, rvrBlue } )
end
...
function RevertConfigSettings()
	...
	-- General Settings
	--
	window.W.General.EnableUnitFrame_Checkbox:SetValue( Pure.Get( "friendly-frame-show" ) )
	window.W.General.ClickThroughUnitFrame_Checkbox:SetValue( not Pure.Get( "friendly-frame-handleinput" ) )
	window.W.General.EnableClassArchtypeColoringName_Checkbox:SetValue( Pure.Get( "friendly-arch-color" ) )
	window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:SetValue( Pure.Get( "friendly-arch-color-hitpoints" ) )
	window.W.General.ShowInSiegeWeapon_Checkbox:SetValue( Pure.Get( "friendly-frame-showinsiege" ) )
	frameAlpha							= Pure.Get( "friendly-frame-alpha" )
	...
	-- Effect Settings
	--
	window.W.Effects.EnableEffectTracker_Checkbox:SetValue( Pure.Get( "friendly-effects-show" ) )
	window.W.Effects.ShowEffectLabels_Checkbox:SetValue( Pure.Get( "friendly-effects-showlabels" ) )
	window.W.Effects.ShowSelfCastEffectsOnly_Checkbox:SetValue( Pure.Get( "friendly-effects-selfcastonly" ) )
	window.W.Effects.ShowMythicStyleBorder_Checkbox:SetValue( Pure.Get( "friendly-effects-mythicborder" ) )
	window.W.Effects.EffectRows_Textbox:SetText( towstring( Pure.Get( "friendly-effects-rows" ) ) )
	window.W.Effects.EffectColumns_Textbox:SetText( towstring( Pure.Get( "friendly-effects-cols" ) ) )
	window.W.Effects.EffectWidth_Textbox:SetText( towstring( Pure.Get( "friendly-effects-dx" ) ) )
	window.W.Effects.EffectHeight_Textbox:SetText( towstring( Pure.Get( "friendly-effects-dy" ) ) )
	window.W.Effects.Anchor_Combo:SelectIndex( anchorsLookup[Pure.Get( "friendly-effects-anchor" )] )
	window.W.Effects.AnchorRowOffset_Textbox:SetText( towstring( Pure.Get( "friendly-effects-row-offset" ) ) )
	window.W.Effects.AnchorColumnOffset_Textbox:SetText( towstring( Pure.Get( "friendly-effects-col-offset" ) ) )
	effectAlpha								= Pure.Get( "friendly-effects-alpha" )
	...
	effectFontAlpha							= Pure.Get( "friendly-effects-font-alpha" )
	...
	-- Dispel Settings
	--
	dispelRed, dispelGreen, dispelBlue 	= unpack( Pure.Get( "friendly-dispel-color" ) )
	dispelAlpha							= Pure.Get( "friendly-dispel-alpha" )
	window.W.Dispel.EnableDispelHighlighting_Checkbox:SetValue( Pure.Get( "friendly-dispel-show" ) )
	...
	-- Color Settings
	--
	hitRed, hitGreen, hitBlue = unpack( Pure.Get( "friendly-hitpoints-status-color" ) )
    ...
    actionRed, actionGreen, actionBlue = unpack( Pure.Get( "friendly-actionpoints-status-color" ) )
    ...
    rvrRed, rvrGreen, rvrBlue = unpack( Pure.Get( "friendly-rvr-flag-color" ) )
...
function PureConfig_TargetFriendly_OnUpdate()
