...
function InitializeWindow()
    ...
    e:SetText( T["Enable Player Pet Target Unit Frame"] )
    ...
    e:Resize( 450 )
    e:Align( "center" )
    e:AnchorTo( window.W.General, "top", "top", 0, 130 )
    e:Font( "font_chat_text" )
...
function ApplyConfigSettings()
	...
	-- General Settings
	--
	Pure.Set( "playerpettarget-frame-show", window.W.General.EnableUnitFrame_Checkbox:GetValue() )
	Pure.Set( "playerpettarget-frame-handleinput", not window.W.General.ClickThroughUnitFrame_Checkbox:GetValue() )
	Pure.Set( "playerpettarget-frame-showinsiege", not window.W.General.ShowInSiegeWeapon_Checkbox:GetValue() )
	Pure.Set( "playerpettarget-frame-alpha", frameAlpha )
	Pure.Set( "playerpettarget-frame-font-alpha", fontAlpha )
	
	--
	-- Color Settings
	--
	Pure.Set( "playerpettarget-hitpoints-status-color", { hitRed, hitGreen, hitBlue } )
end
...
function RevertConfigSettings()
	...
	-- General Settings
	--
	window.W.General.EnableUnitFrame_Checkbox:SetValue( Pure.Get( "playerpettarget-frame-show" ) )
	window.W.General.ClickThroughUnitFrame_Checkbox:SetValue( not Pure.Get( "playerpettarget-frame-handleinput" ) )
	window.W.General.ShowInSiegeWeapon_Checkbox:SetValue( not Pure.Get( "playerpettarget-frame-showinsiege" ) )
	frameAlpha							= Pure.Get( "playerpettarget-frame-alpha" )
	...
	fontAlpha							= Pure.Get( "playerpettarget-frame-font-alpha" )
	...
	-- Color Settings
	--
	hitRed, hitGreen, hitBlue = unpack( Pure.Get( "playerpettarget-hitpoints-status-color" ) )
...
function PureConfig_PlayerPetTarget_OnUpdate()
