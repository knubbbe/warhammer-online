...
function InitializeWindow()
    ...
    e:SetText( T["Enable Group Unit Frame"] )
    ...
    -- General - Show Player In Group Checkbox
	e = window.W.General( "Checkbox" )
	e:AnchorTo( window.W.General.ShowInScenario_Checkbox, "bottomleft", "topleft", 0, 5 )
	window.W.General.ShowPlayerInGroup_Checkbox = e
    
    -- General - Show Player In Group Label
    e = window.W.General( "Label" )
    e:Resize( 450 )
    e:Align( "leftcenter" )
    e:AnchorTo( window.W.General.ShowPlayerInGroup_Checkbox, "right", "left", 10, 0 )
    e:Font( "font_chat_text" )
    e:SetText( T["Show Player In Group"] )
    window.W.General.ShowPlayerInGroup_Label = e
    
    -- General - Enable Class Archtype Coloring - Name Checkbox
	e = window.W.General( "Checkbox" )
	e:AnchorTo( window.W.General.ShowPlayerInGroup_Checkbox, "bottomleft", "topleft", 0, 5 )
	...
	e = window.W.General( "Checkbox" )
	e:AnchorTo( window.W.General.ShowClassName_Checkbox, "bottomleft", "topleft", 0, 5 )
    ...
    window.W.General.ShowInSiegeWeapon_Label = e
     ...
     -- General - Group Leader Indication Label
    e = window.W.General( "Label" )
    e:Resize( 300 )
    e:AnchorTo( window.W.General.ShowInSiegeWeapon_Checkbox, "bottomleft", "topleft", 0, 5 )
    e:Font( "font_chat_text" )
    e:Align( "leftcenter" )
    e:SetText( T["Group Leader Indicator:"] )
    window.W.General.GroupLeaderIndicator_Label = e
    
    -- General - Group Leader Indication Textbox
    e = window.W.General( "Textbox" )
    e:Resize( 200 )
    e:AnchorTo( window.W.General.GroupLeaderIndicator_Label, "bottomleft", "topleft", 0, 0 )
    window.W.General.GroupLeaderIndicator_Textbox = e
    
    -- General - Group Leader Indication Button
    e = window.W.General( "Button", nil, "EA_Button_DefaultResizeable" )
    e:Resize( 150 )
    e:Show( true )
    e:AnchorTo( window.W.General.GroupLeaderIndicator_Textbox, "topright", "topleft", 5, -2 )
    e:SetText( T["Default"] )
    e.OnLButtonUp = function() window.W.General.GroupLeaderIndicator_Textbox:SetText( Pure.GetDefault( "group-leader-indicator" ) ) end
    window.W.General.GroupLeaderIndicator_Button = e
    
    -- General - Growth Direction Label
    e = window.W.General( "Label" )
    e:Resize( 300 )
    e:AnchorTo( window.W.General.GroupLeaderIndicator_Textbox, "bottomleft", "topleft", 0, 5 )
    e:Font( "font_chat_text" )
    e:Align( "leftcenter" )
    ...
    e:Resize( 450 )
    e:Align( "center" )
    e:AnchorTo( window.W.General, "top", "top", 0, 470 )
    e:Font( "font_chat_text" )
...
function ApplyConfigSettings()
	...
	-- General Settings
	--
	Pure.Set( "group-frame-show", window.W.General.EnableUnitFrame_Checkbox:GetValue() )
	Pure.Set( "group-frame-showinscenario", window.W.General.ShowInScenario_Checkbox:GetValue() )
	Pure.Set( "group-player-show", window.W.General.ShowPlayerInGroup_Checkbox:GetValue() )
	Pure.Set( "group-arch-color", window.W.General.EnableClassArchtypeColoringName_Checkbox:GetValue() )
	Pure.Set( "group-arch-color-hitpoints", window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:GetValue() )
	Pure.Set( "group-frame-handleinput", not window.W.General.ClickThroughUnitFrame_Checkbox:GetValue() )
	Pure.Set( "group-classname-show", window.W.General.ShowClassName_Checkbox:GetValue() )
	Pure.Set( "group-frame-showinsiege", window.W.General.ShowInSiegeWeapon_Checkbox:GetValue() )
	Pure.Set( "group-fill-direction", growthDirections[window.W.General.GrowthDirection_Combo:SelectedIndex()].config )
	Pure.Set( "group-frame-vertical-offset", tonumber( window.W.General.VerticalGrowthOffset_Textbox:GetText() ) or Pure.GetDefault( "group-frame-vertical-offset" ) )
	Pure.Set( "group-frame-horizontal-offset", tonumber( window.W.General.HorizontalGrowthOffset_Textbox:GetText() ) or Pure.GetDefault( "group-frame-horizontal-offset" ) )
	Pure.Set( "group-leader-indicator", window.W.General.GroupLeaderIndicator_Textbox:GetText() )
	Pure.Set( "group-frame-alpha", frameAlpha )
	Pure.Set( "group-frame-font-alpha", fontAlpha )	
	
	--
	-- Effect Settings
	--
	Pure.Set( "group-effects-show", window.W.Effects.EnableEffectTracker_Checkbox:GetValue() )
	Pure.Set( "group-effects-showlabels", window.W.Effects.ShowEffectLabels_Checkbox:GetValue() )
	Pure.Set( "group-effects-selfcastonly", window.W.Effects.ShowSelfCastEffectsOnly_Checkbox:GetValue() )
	Pure.Set( "group-effects-mythicborder", window.W.Effects.ShowMythicStyleBorder_Checkbox:GetValue() )
	Pure.Set( "group-effects-rows", tonumber( window.W.Effects.EffectRows_Textbox:GetText() ) or Pure.GetDefault( "group-effects-rows" ) )
	Pure.Set( "group-effects-cols", tonumber( window.W.Effects.EffectColumns_Textbox:GetText() ) or Pure.GetDefault( "group-effects-cols" ) )
	Pure.Set( "group-effects-dx", tonumber( window.W.Effects.EffectWidth_Textbox:GetText() ) or Pure.GetDefault( "group-effects-dx" ) )
	Pure.Set( "group-effects-dy", tonumber( window.W.Effects.EffectHeight_Textbox:GetText() ) or Pure.GetDefault( "group-effects-dy" ) )
	Pure.Set( "group-effects-anchor", anchors[window.W.Effects.Anchor_Combo:SelectedIndex()].config )
	Pure.Set( "group-effects-row-offset", tonumber( window.W.Effects.AnchorRowOffset_Textbox:GetText() ) or Pure.GetDefault( "group-effects-row-offset" ) )
	Pure.Set( "group-effects-col-offset", tonumber( window.W.Effects.AnchorColumnOffset_Textbox:GetText() ) or Pure.GetDefault( "group-effects-col-offset" ) )
	Pure.Set( "group-effects-alpha", effectAlpha )
	Pure.Set( "group-effects-font-alpha", effectFontAlpha )
	
	--
	-- Dispel Settings
	--
	Pure.Set( "group-dispel-show", window.W.Dispel.EnableDispelHighlighting_Checkbox:GetValue() )
	Pure.Set( "group-dispel-color", { dispelRed, dispelGreen, dispelBlue } )
	Pure.Set( "group-dispel-alpha", dispelAlpha )
	
	--
	-- Target Settings
	--
	Pure.Set( "group-target-highlight-show", window.W.Target.EnableTargetHighlighting_Checkbox:GetValue() )
	Pure.Set( "group-target-highlight-color", { targetRed, targetGreen, targetBlue } )
	Pure.Set( "group-target-highlight-alpha", targetAlpha )
	
	--
	-- Color Settings
	--
	Pure.Set( "group-hitpoints-status-color", { hitRed, hitGreen, hitBlue } )
	Pure.Set( "group-actionpoints-status-color", { actionRed, actionGreen, actionBlue } )
	Pure.Set( "group-morale-color", { moraleRed, moraleGreen, moraleBlue } )
	Pure.Set( "group-rvr-flag-color", { rvrRed, rvrGreen, rvrBlue } )
end
...
function RevertConfigSettings()
	...
	-- General Settings
	--
	window.W.General.EnableUnitFrame_Checkbox:SetValue( Pure.Get( "group-frame-show" ) )
	window.W.General.ShowInScenario_Checkbox:SetValue( Pure.Get( "group-frame-showinscenario" ) )
	window.W.General.ShowPlayerInGroup_Checkbox:SetValue( Pure.Get( "group-player-show" ) )
	window.W.General.EnableClassArchtypeColoringName_Checkbox:SetValue( Pure.Get( "group-arch-color" ) )
	window.W.General.EnableClassArchtypeColoringHitpoints_Checkbox:SetValue( Pure.Get( "group-arch-color-hitpoints" ) )
	window.W.General.ClickThroughUnitFrame_Checkbox:SetValue( not Pure.Get( "player-frame-handleinput" ) )
	window.W.General.ShowClassName_Checkbox:SetValue( Pure.Get( "group-classname-show" ) )
	window.W.General.ShowInSiegeWeapon_Checkbox:SetValue( Pure.Get( "group-frame-showinsiege" ) )
	window.W.General.GrowthDirection_Combo:SelectIndex( growthDirectionLookup[Pure.Get( "group-fill-direction" )] )
	window.W.General.VerticalGrowthOffset_Textbox:SetText( towstring( Pure.Get( "group-frame-vertical-offset" ) ) )
	window.W.General.HorizontalGrowthOffset_Textbox:SetText( towstring( Pure.Get( "group-frame-horizontal-offset" ) ) )
	window.W.General.GroupLeaderIndicator_Textbox:SetText( Pure.Get( "group-leader-indicator" ) )
	frameAlpha							= Pure.Get( "group-frame-alpha" )
	...
	fontAlpha							= Pure.Get( "group-frame-font-alpha" )
	...
	-- Effect Settings
	--
	window.W.Effects.EnableEffectTracker_Checkbox:SetValue( Pure.Get( "group-effects-show" ) )
	window.W.Effects.ShowEffectLabels_Checkbox:SetValue( Pure.Get( "group-effects-showlabels" ) )
	window.W.Effects.ShowSelfCastEffectsOnly_Checkbox:SetValue( Pure.Get( "group-effects-selfcastonly" ) )
	window.W.Effects.ShowMythicStyleBorder_Checkbox:SetValue( Pure.Get( "group-effects-mythicborder" ) )
	window.W.Effects.EffectRows_Textbox:SetText( towstring( Pure.Get( "group-effects-rows" ) ) )
	window.W.Effects.EffectColumns_Textbox:SetText( towstring( Pure.Get( "group-effects-cols" ) ) )
	window.W.Effects.EffectWidth_Textbox:SetText( towstring( Pure.Get( "group-effects-dx" ) ) )
	window.W.Effects.EffectHeight_Textbox:SetText( towstring( Pure.Get( "group-effects-dy" ) ) )
	window.W.Effects.Anchor_Combo:SelectIndex( anchorsLookup[Pure.Get( "group-effects-anchor" )] )
	window.W.Effects.AnchorRowOffset_Textbox:SetText( towstring( Pure.Get( "group-effects-row-offset" ) ) )
	window.W.Effects.AnchorColumnOffset_Textbox:SetText( towstring( Pure.Get( "group-effects-col-offset" ) ) )
	effectAlpha								= Pure.Get( "group-effects-alpha" )
	...
	effectFontAlpha							= Pure.Get( "group-effects-font-alpha" )
	...
	-- Dispel Settings
	--
	dispelRed, dispelGreen, dispelBlue 	= unpack( Pure.Get( "group-dispel-color" ) )
	dispelAlpha							= Pure.Get( "group-dispel-alpha" )
	window.W.Dispel.EnableDispelHighlighting_Checkbox:SetValue( Pure.Get( "group-dispel-show" ) )
	...
	-- Target Settings
	--
	targetRed, targetGreen, targetBlue 	= unpack( Pure.Get( "group-target-highlight-color" ) )
	targetAlpha							= Pure.Get( "group-target-highlight-alpha" )
	window.W.Target.EnableTargetHighlighting_Checkbox:SetValue( Pure.Get( "group-target-highlight-show" ) )
	...
	-- Color Settings
	--
	hitRed, hitGreen, hitBlue = unpack( Pure.Get( "group-hitpoints-status-color" ) )
    ...
    actionRed, actionGreen, actionBlue = unpack( Pure.Get( "group-actionpoints-status-color" ) )
    ...
    moraleRed, moraleGreen, moraleBlue = unpack( Pure.Get( "group-morale-color" ) )
    ...
    rvrRed, rvrGreen, rvrBlue = unpack( Pure.Get( "group-rvr-flag-color" ) )
...
function PureConfig_Group_OnUpdate()
